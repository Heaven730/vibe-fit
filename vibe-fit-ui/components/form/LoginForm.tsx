 ...
 * Props:
 * - theme: 主题 token，驱动颜色
 * - onSubmit: 校验通过并点击后触发，携带 email / password
 * - onSignUp: 点击「Sign up」跳转回调
 */
export function LoginForm({ theme, onSubmit, onSignUp }: LoginFormProps) {
  ...
  return (
    <View>
      ...
      <View style={styles.divider}>
        ...
        <Text style={[styles.dividerText, { color: theme.textPlaceholder }]}>or</Text>
        <View style={[styles.dividerLine, { backgroundColor: theme.border }]} />
      </View>
